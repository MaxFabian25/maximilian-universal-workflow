...
- goal-planning: output exact `/goal <objective>` plus the later `execution` invocation; do not claim `/goal` ran. Keep the objective under 4,000 characters; put long instructions in the execution prompt or a repo file.

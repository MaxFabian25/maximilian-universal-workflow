...
- handoff (`handoff_closeout`, `cleanup_choice`): choose stop with evidence, keep branch, or create PR; ask again before merge, push, delete, discard, or destructive cleanup.

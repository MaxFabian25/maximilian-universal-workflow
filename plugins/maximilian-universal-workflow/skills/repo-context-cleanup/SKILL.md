...
Follow `../../docs/workflow-contracts/README.md`, `../../docs/workflow-contracts/phase-transition.md`, `../../docs/workflow-contracts/phase-bundle.md`, and `references/cleanup-playbook.md`. Active instructions/specs/docs outrank this skill.
...
- Before mutating cleanup actions, confirm branch safety is already resolved through `git-worktrees` or explicit current-branch approval; otherwise route to `git-worktrees` or stop with the cleanup proposal.

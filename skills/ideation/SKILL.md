...
Read `../../docs/workflow-contracts/phase-runtime.md`, `../../docs/workflow-contracts/phase-transition.md`, `../../docs/workflow-contracts/phase-bundle.md`, `../../docs/workflow-contracts/evidence-discipline.md`, `../../docs/workflow-contracts/decision-interrogation.md`, `../../docs/workflow-contracts/vocabulary-decision-capture.md`, `../../docs/workflow-contracts/question-first-scratch-work.md`, `../../docs/workflow-contracts/information-structure.md`, `../../docs/workflow-contracts/work-item-shaping.md`, `../../docs/workflow-contracts/request-user-input.md`, and `references/ideation-branches.md`. Read `../../docs/workflow-contracts/README.md` only for authority/setup.
...
- Include information-structure, vocabulary, decision-capture, and work-item implications when they differ across options.
